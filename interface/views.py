from interface.models import (Question, MultipleChoiceQuestion, CodeQuestion,
                              Choice, TestCase, Rating, Review, Input, Output
                              )
from django.shortcuts import render,get_object_or_404
from django.http import HttpResponse,HttpResponseRedirect
from interface.forms import (RegistrationForm, MultipleChoiceQuestionForm,
                             CodeQuestionForm, InputForm, OutputForm
                             )
